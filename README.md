...
1. Using your [Power BI Desktop](https://powerbi.microsoft.com/en-us/desktop/) editor, create a new report, select *Transform data* > *Transform Data* which will launch the Transform Data window, and in there, select the *View* tab and check the *Always allow* checkbox with the *Parameters* section, and close the window.  

   <img src="./images/alwaysAllowParams.jpg" width=450> 
2. Back in the PBI Desktop window, select *Transform data* and select *Data source settings*.
